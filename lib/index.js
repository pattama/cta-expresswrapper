...
class ExpressWrapper {
  ...
  constructor(configuration, dependencies) {
    ...
    if (!configuration.hasOwnProperty('port') || typeof configuration.port !== 'number') {
    ...
    if (!dependencies.hasOwnProperty('logger')) {
      throw (new Error(`missing/incorrect 'logger' tool in dependencies`));
    }
